...
(
    ...
    CONSTRAINT countries_population_check
        CHECK ("population" >= 0),

    CONSTRAINT countries_are_in_sq_km_check
        CHECK ("area_in_sq_km" >= 0)
);

INSERT INTO "countries" ("country_code", "iso_code", "country_name", "currency_code", "continent_code", "population", "area_in_sq_km", "capital")
VALUES ('AD', NULL, 'Andorra', 'EUR', 'EU', 84000, 468, 'Andorra la Vella'),
...
(
    ...
    CONSTRAINT countries_river_id_check
        CHECK ("river_id" >= 0)
);
...
(
    ...
    CONSTRAINT countries_mountain_id_check
        CHECK ("mountain_id" >= 0)
);
...
(
    ...
    CONSTRAINT peaks_elevation_check
        CHECK ("elevation" >= 0),

    CONSTRAINT peaks_mountain_id_check
        CHECK ("mountain_id" >= 0)
);

INSERT INTO "peaks" ("peak_name", "elevation", "mountain_id")
VALUES ('Aconcagua', 6962, 3),
       ('Botev', 2376, 4),
...
(
    ...
    CONSTRAINT rivers_length_check
        CHECK ("length" >= 0),

    CONSTRAINT rivers_drainage_area_check
        CHECK ("drainage_area" >= 0),

    CONSTRAINT rivers_average_discharge_check
        CHECK ("average_discharge" >= 0)
);

INSERT INTO "rivers" ("river_name", "length", "drainage_area", "average_discharge", "outflow")
VALUES ('Nile', 6650, 3254555, 5100, 'Mediterranean'),
