...
INSERT INTO "books"("author_id", "title", "year_of_release", "cost", "description")
VALUES (1, 'Unfinished Portrait', '1930-01-01', 15.99,
       ...
       (1, 'The Mysterious Affair at Styles', '1920-01-01', 17.99,
        'The Mysterious Affair at Styles is the first detective novel by British writer Agatha Christie, introducing her fictional detective Hercule Poirot. It was written in the middle of the First World War, in 1916, and first published by John Lane in the United States in October 1920.'),
...
INSERT INTO "triangles"("side", "height")
VALUES (2, 4),
       (1, 18),
       (4.5, 3),
       (8, 12),
