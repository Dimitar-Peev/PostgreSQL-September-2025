DROP DATABASE IF EXISTS "data_aggregation_softuni_management_db";
...
(
    ...
    CONSTRAINT departments_manager_id_check
        CHECK ("manager_id" > 0)
);
...
(
    ...
    CONSTRAINT employees_department_id_check
        CHECK ("department_id" > 0),

    CONSTRAINT employees_manager_id_check
        CHECK ("manager_id" > 0),

    CONSTRAINT employees_salary_check
        CHECK ("salary" >= 0),

    CONSTRAINT employees_address_id_check
        CHECK ("address_id" > 0)
);

INSERT INTO "employees" ("first_name", "last_name", "job_title", "department_id", "manager_id", "hire_date", "salary", "address_id")
VALUES ('Guy', 'Gilbert', 'Production Technician', 7, 16, '1998-07-31 00:00:00.000000', 12500.0000, 166),
       ...
       ('Diane', 'Margheim', 'Research and Development Engineer', 6, 158, '2001-01-30 00:00:00.000000', 40900.0000,
        111),
       ...
       ('Pilar', 'Ackerman', 'Shipping and Receiving Supervisor', 15, 21, '2001-02-03 00:00:00.000000', 19200.0000,
        269),
       ...
       ('David', 'Barber', 'Assistant to the Chief Financial Officer', 10, 140, '2001-02-13 00:00:00.000000',
        13500.0000, 173),
       ...
       ('Hao', 'Chen', 'Human Resources Administrative Assistant', 9, 30, '2001-03-10 00:00:00.000000', 13900.0000,
        135),
       ...
       ('Grant', 'Culbertson', 'Human Resources Administrative Assistant', 9, 30, '2001-03-29 00:00:00.000000',
        13900.0000, 117),
